...
const FN_PP_BUILD_COT_V2 = [
  ...
  "//",
  "// The inject driving this tab fires every 60s and the poll gate can only SLOW",
  "// that, never speed it up, so the real heartbeat is max(60, pollIntervalSec).",
  "// Stale is that plus a margin: one missed beat will not flicker the marker, but",
  "// a cleared call disappears within about two cycles instead of ten minutes.",
  "var PP_TICK_SEC = 60;",
  "var effPollSec = Math.max(PP_TICK_SEC, Number(cfg.pollIntervalSec) || PP_TICK_SEC);",
